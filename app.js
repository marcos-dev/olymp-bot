...
const favoriteCode = `javascript:(function(){var s=document.createElement('script');s.src='https://marcos-dev.github.io/olymp-bot/public/robot.js?'+Date.now();(document.head||document.documentElement).appendChild(s);})();`;
